...
#define CONFIG_LED_MAX_INTENSITY_SCALE 128
...
{ // Turn LED On or Off
    ...
    duty = map(duty, 0, CONFIG_LED_MAX_INTENSITY, 0, CONFIG_LED_MAX_INTENSITY_SCALE);
    ledc_set_duty(CONFIG_LED_LEDC_SPEED_MODE, LEDC_CHANNEL_0, duty);
    ledc_update_duty(CONFIG_LED_LEDC_SPEED_MODE, LEDC_CHANNEL_0);
